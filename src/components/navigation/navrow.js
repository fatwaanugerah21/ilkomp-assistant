    ...
    <div className="second-background-color">
      <nav className="nav-wrapper">
        ...
        <ul id="navigation-list" className="nav-row hide-on-mobile">
          ...
          />
          <NavLink to="/learn">
            <li className="nav-item nav-item1" onClick={closeSideMenu}>
              Learn
            </li>
          </NavLink>
          <NavLink to="/project">
            <li className="nav-item nav-item2" onClick={closeSideMenu}>
              Proyek
            </li>
          </NavLink>
          <NavLink to="/contact-us">
            <li className="nav-item nav-item3" onClick={closeSideMenu}>
              Contact Us
            </li>
          </NavLink>
        </ul>
