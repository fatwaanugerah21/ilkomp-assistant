...
const AddPhoneNumber = (props) => {
   ...
   return (
      <OwnModal show={props.show} header={<h1>Tambah nomor handphone</h1>} onClick={() => { props.onClick() }} >
         <div className="contact-us-page card container">
            <form onSubmit={handleSubmit} className="add-contact-form">
               <div className="name-input input-container">
                  ...
                  <input className="add-contact-input" id="name" type="text" placeholder="Pak Iswanto" onChange={handleInputChange} />
               </div>
               <div className="number-input input-container">
                  ...
                  <div className="number-input-field">
                     ...
                     <input className="add-contact-input number" value={numberShow()} type="text" placeholder="812 3456 7890" onChange={handlePhoneChange} />
                  </div>
               </div>
               <div className="address-input input-container">
                  <span className="addres-label white-text">Alamat :</span>
                  <input className="add-contact-input" id="address" type="address" placeholder="Jl. Cakalang" onChange={handleInputChange} />
               </div>
...
const addDispatchToProps = (dispatch) => {
   return ({
      addPhoneNumber: (information) => { dispatch(AddPhoneNumberAction(information)) }
   })
}
